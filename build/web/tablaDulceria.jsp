...
<%@page import="Model.DulceriaDAO, Model.Dulceria, java.util.List, java.util.LinkedList" %>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="cars shadow">
            <div class="card-body">
                <div class="table-responsive">
                    <h2 style="margin-top: 30px;">Listado de Dulceria</h2>     
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="text-center mt-3">
                                <button class="btn btn-primary" onclick="redirigirAInsertarDulceria()">
                                    <a href="nuevaDulceria.jsp" style="text-decoration: none; color: inherit;">Insertar Dulceria</a></button>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="ControladorDulceria?accion=Eliminar&codigo=<%= lista.get(i).getCodigo() %>"><button class="btn btn-sm btn-danger">
                    ...
                    <script>
                        function redirigirAInsertarDulceria() {
                            window.location.href = 'nuevaDulceria.jsp'; // Reemplaza 'insertarEmpleado.jsp' con la ruta correcta de tu JSP destino
                        }
                    </script>
