...
<%@page import="Model.UsuarioDAO, Model.Usuario, java.util.List, java.util.LinkedList" %>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="cars shadow">
            <div class="card-body">
                <div class="table-responsive">
                    <h2 style="margin-top: 30px;">Listado de Empleados</h2>  
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="text-center mt-3">
                                <button class="btn btn-primary" onclick="redirigirAInsertarEmpleado()">
                                    <a href="nuevoEmpleado.jsp" style="text-decoration: none; color: inherit;">Insertar Empleado</a></button>
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <th><%= lista.get(i).getNombres() %></th>
                                <th><%= lista.get(i).getApellidos() %></th>
                                <th><%= lista.get(i).getCorreo() %></th>
                                <th><%= lista.get(i).getTelefono() %></th>
                                <th><%= lista.get(i).getDni() %></th>
                                <th><%= lista.get(i).getUsuario() %></th>
                                <th><%= lista.get(i).getContrasena() %></th>
                                <th><%= lista.get(i).getRol() %></th>
                                <th><img src="<%= lista.get(i).getImagen() %>" height="50" width="50"></th>
                                <td class="text-center">
                                    <button class="btn btn-sm btn-primary">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <a href="ControladorEmpleado?accion=Eliminar&codigo=<%= lista.get(i).getCodigo() %>"><button class="btn btn-sm btn-danger">
                    ...
                    <script>
                        function redirigirAInsertarEmpleado() {
                            window.location.href = 'nuevoEmpleado.jsp'; // Reemplaza 'insertarEmpleado.jsp' con la ruta correcta de tu JSP destino
                        }
                    </script>
