                ...
                <div class="table-responsive">
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <td class="text-center"><%= lista.get(i).getCodigo() %></td>
                                <th><img src="<%= lista.get(i).getImagen() %>"" height="50" width="50"></th>
                                <td class="text-center"><%= lista.get(i).getNombres() %></td>
                                <td class="text-center"><%= lista.get(i).getApellidos() %></td>
                                <td class="text-center"><%= lista.get(i).getCorreo() %></td>
                                <td class="text-center"><%= lista.get(i).getContrasena() %></td>
                                <td class="text-center"><%= lista.get(i).getTelefono() %></td>

                                <td class="text-center">
                                    <button class="btn btn-sm btn-primary">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <a href="ControladorUsuario?accion=Eliminar&codigo=<%= lista.get(i).getCodigo() %>"><button class="btn btn-sm btn-danger">
