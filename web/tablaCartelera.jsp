...
<%@page import="Model.PeliculaDAO, Model.Pelicula, java.util.List, java.util.LinkedList" %>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="cars shadow">
            <div class="card-body">
                <div class="table-responsive">
                    <h2 style="margin-top: 30px;">Listado de Peliculas</h2>     
                    ...
                    <div class="botones">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="text-center mt-3">
                                <button class="btn btn-primary" onclick="redirigirAInsertarEmpleado()">
                                    <a href="ControladorEmpleado?accion=VICartelera&codigo=<%= emp.getCodigo()%>" style="text-decoration: none; color: inherit;">Insertar Pelicula</a></button>
                    ...
                    <table id="example" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Costo del boleto</th>
                        ...
                        <tbody>
                            ...
                            %>
                            <tr>
                                <th><%= lista.get(i).getNombreP() %></th>
                                <th><%= lista.get(i).getDirector() %></th>
                                <th><%= lista.get(i).getFechaEstreno() %></th>
                                <th><%= lista.get(i).getActor() %></th>
                                <th><%= lista.get(i).getClasificacion() %></th>
                                <th><%= lista.get(i).getCosto() %></th>
                                <th><img src="<%= lista.get(i).getImagen() %>" height="50" width="50"></th>
                                <td class="text-center">
                                    <button class="btn btn-sm btn-primary">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <a href="ControladorPelicula?accion=Eliminar&codigo=<%= lista.get(i).getIdPelicula() %>">
                    ...
                    <script>
                        function redirigirAInsertarEmpleado() {
                            window.location.href = 'nuevaCartelera.jsp'; // Reemplaza 'insertarEmpleado.jsp' con la ruta correcta de tu JSP destino
                        }
                    </script>
